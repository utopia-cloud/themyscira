...
@Component("rawCorporateInputReadListener")
class RawCorporateInputReadListener : ItemReadListener<RawCorporateInput> {
    private val log: Logger = LoggerFactory.getLogger(ScheduledTasks::class.java)
    override fun afterRead(item: RawCorporateInput) {
//        log.info("afterRead")
        return
    }
